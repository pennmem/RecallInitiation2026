function runExperiment() {
  ...
  var instructions = {
    type: "instructions",
    pages: [
      "<p>Congratulations! Based on your performance in our previous rounds of data collection \
            you have qualified for part 5 of our experiment.</p> \
            <p>Thank you for your attention and effort in parts 1-4.</p> \
  ...
  var save_and_redirect = {
    ...
    func: function (done) {
      jsPsych.data.addProperties({
        ...
        num_lists: num_lists,
        session: 4, // change to 2, 3, 4 per file
        replays: tot_replays,
        prolific_pid: prolific_pid,
        study_id: study_id,
        session_id: session_id,

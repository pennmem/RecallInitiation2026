function runExperiment() {
    ...
    jsPsych.init({
        ...
        on_finish: function() {
            jsPsych.data.addProperties({condition: condition_row, l_length: list_length, pres_rate: presentation_rate, num_lists: num_lists, session: 4, replays: tot_replays, worker_id: workerId});
